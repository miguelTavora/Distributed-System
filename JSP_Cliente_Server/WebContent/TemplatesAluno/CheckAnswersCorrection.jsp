		...
		<div class="container-login100"
			...
			<div class="wrap-login100" style="width: 70%;">
				...
				<span class="login100-form-title p-b-34 p-t-27"
					style="padding-top: 0px; font-size: 45px;">Answers Correction</span>


				<div style="display: flex; align-items: center">
					<textarea id="w3review" name="w3review" rows="40" cols="200" style="text-align: left;" disabled>
<% if (session.getAttribute("showAnswersCorrection") != null) {%>
<%pageContext.getOut().write("" + (session.getAttribute("showAnswersCorrection")));%>
<%}%>
